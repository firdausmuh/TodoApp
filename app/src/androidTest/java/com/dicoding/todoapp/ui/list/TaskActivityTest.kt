...
class TaskActivityTest {
    ...
    @Test
    fun loadAddTask() {
        onView(ViewMatchers.withId(R.id.rv_task))
        ...
        onView(ViewMatchers.withId(R.id.add_ed_title))
            .check(ViewAssertions.matches(ViewMatchers.isDisplayed()))
        onView(ViewMatchers.withId(R.id.add_ed_description))
            .check(ViewAssertions.matches(ViewMatchers.isDisplayed()))
        onView(ViewMatchers.withId(R.id.add_tv_due_date))
            .check(ViewAssertions.matches(ViewMatchers.isDisplayed()))
    }
